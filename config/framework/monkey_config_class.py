...
class MonkeyConfig:
    ...
    EDITOR_MODEL: Optional[int] = field(default=None)
    ...
    EDITOR_TEMP: Optional[ScalarFloat] = field(default=None)
    ...
    def __post_init__(self):
        ...
        self.EDITOR_MODEL = validate_int('EDITOR_MODEL', self.EDITOR_MODEL)
        ...
        self.EDITOR_TEMP = validate_float('EDITOR_TEMP', self.EDITOR_TEMP)
